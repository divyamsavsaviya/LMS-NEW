...
const SubjectForm = () => {
    const [subjects, setSubjects] = useState([{ subName: "", subCode: "", sessions: "", courseDescription: "" }]);
    ...
    const handleCourseDescriptionChange = (index) => (event) => {
        const newSubjects = [...subjects];
        newSubjects[index].courseDescription = event.target.value;
        setSubjects(newSubjects);
    };

    const handleAddSubject = () => {
        setSubjects([...subjects, { subName: "", subCode: "", courseDescription: "" }]);
    };
                    ...
                    <React.Fragment key={index}>
                        ...
                        <Grid item xs={6}>
                            <TextField
                                ...
                                variant="outlined"
                                value={subject.courseDescription}
                                onChange={handleCourseDescriptionChange(index)}
                                sx={styles.inputField}
                                required
                            />
                        </Grid>
